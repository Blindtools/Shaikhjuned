    ...
    sock.ev.on("messages.upsert", async ({ messages }) => {
        ...
        try {
            ...
            // Handle button responses
                ...
                switch (selectedButtonId) {
                    ...
                    case 'stop_service':
                        ...
                        break;
                    case 'weather':
                        replyText = `☁️ *Weather Information*\n\n` +
                                  `To get the current weather, please type:\n` +
                                  `*weather in [City Name]* (e.g., weather in London)\n\n` +
                                  `Type *menu* to return to main menu.\n\n` +
                                  `---\n💡 Powered by Shaikh Juned - shaikhjuned.co.in`;
                        break;
                    default:
            ...
            // Handle text messages
                ...
                replyText = `Hello ${senderName}! I'm an AI assistant created by Shaikh Juned (shaikhjuned.co.in). I can help you with text messages, analyze images, extract text from PDFs, and transcribe audio messages with voice responses.\n\n📋 Type *menu* to see all available options.\n\nHow can I assist you today?`;
            }
