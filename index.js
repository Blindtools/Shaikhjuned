        ...
        try {
            ...
            if (incomingText.toLowerCase() === 'menu' || incomingText.toLowerCase() === '/menu') {
                replyText = `🤖 *AI Assistant Menu*\n\n` +
                          ...
                          `📞 *Contact Us* - Get support and contact information\n` +
                          `ℹ️ *About Us* - Learn about our AI assistant\n` +
                          `🛑 *Stop Service* - Temporarily pause the bot\n\n` +
                          `Simply type the option name to continue.\n\n` +
                          `---\n💡 Powered by Shaikh Juned - shaikhjuned.co.in`;
            }
            // Handle Contact Us
            else if (incomingText.toLowerCase().includes('contact us') || incomingText.toLowerCase().includes('contact')) {
            ...
            // Handle About Us
            else if (incomingText.toLowerCase().includes('about us') || incomingText.toLowerCase().includes('about')) {
            ...
            // Handle Stop Service
            else if (incomingText.toLowerCase().includes('stop service') || incomingText.toLowerCase().includes('stop')) {
                ...
                // You could implement actual pause logic here if needed
