...
async function transcribeAudio(audioBuffer) {
    try {
        ...
        console.error("Error transcribing audio with Gemini AI:", error);
...
async function extractTextFromPdf(pdfBuffer) {
    try {
        ...
        console.error("Error extracting text from PDF with Gemini AI:", error);
...
async function describeVideo(videoBuffer) {
    try {
        ...
        console.error("Error describing video with Gemini AI:", error);
